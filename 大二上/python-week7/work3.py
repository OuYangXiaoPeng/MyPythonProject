...
connect = '''Chief Justice Roberts, President Carter, President Clinton, President Bush, President Obama, fellow Americans and people of the world, thank you.
...
day's ceremony, however, has very special meaning. Because today, we are not merely transferring power from one administration to another or from one party to another.
...
# 把标点符号去掉
# 把每个单词分割出来
# print(connect.upper())#大写
# print()
# print(connect.replace(" ",""))#空格去除
# print()
# for c in string.punctuation:#去标点符号
#     connect = connect.replace(c,'')
# print(connect)

upconnect = connect.upper()
...
# 如何统计出现的次数
# 打印次数 词OUR频1
# 写循环每次记录查询有就是1  没有就不增加

from collections import Counter
# 导入这个统计器
A=['a','b','b','c','d','b','a','a']
count=Counter(connect)
print(count)
# 词云尝试画出来